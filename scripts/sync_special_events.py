...
def main() -> None:
    ...
    if today <= butterfly_release_start:
        center_grove_events.append({"title": "Butterfly Release", "when": "Aug 29–30 · 11:00 AM 或 4:00 PM", "location": "Center Grove Orchard · Cambridge", "url": "https://centergroveorchard.com/pages/events/events-gqgphckl", "source": "Center Grove Orchard", "categoryLabel": "Fall Farm Fun", "confidence": "亲子自然活动 · 需购票", "startDate": "2026-08-29", "endDate": "2026-08-30", "ageGroups": ALL_AGES})
